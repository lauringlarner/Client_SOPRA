...
| **Student**        | **Date** | **Link to Commit** | **Description**                 | **Relevance**                       |
| ------------------ | -------- | ------------------ | ------------------------------- | ----------------------------------- |
| **[@AleMarti0]** | [04.04.2026] and [11.04.2026]   | [https://github.com/lauringlarner/Client_SOPRA/commit/4f43fa59b8bacabad00551bc3ee0083263558b68] [https://github.com/lauringlarner/Client_SOPRA/commit/e5b14e729a2e1e85cb6927f322b6d60b45c6a6a3] [https://github.com/lauringlarner/Client_SOPRA/commit/db646b2f3310e7b1ef75b96ca0cbff409970bd96] | [Connecting the Frontend pages (register, login, user profile and submission)with the backend and adapting the frontend to fit the backend data representations] | [The User has to be able to create an account, login and change the password. Without these functionalities, the user could not use our application. Additionally, now the submission page is also connected with the backend, so that the backend can receive the image and validate it and the frontend will now give feedback to the user (e.g. loading circle on bingo board after submitting).] |
