...
|                    | [11.04.2026]   | [https://github.com/lauringlarner/Client_SOPRA/commit/db646b2f3310e7b1ef75b96ca0cbff409970bd96] | [Connecting the image submission with the backend and adding feedback for user when submitting.] | [The submission functionality is one of the main components for the bingo game. The user needs to be able to send the image to the backend and see that the image is getting validated.] |
